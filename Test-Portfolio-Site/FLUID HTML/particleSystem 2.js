(function(w) {
  ...
  function init() {
    ...
    for (i = 0; i < speck_count; i++) {
      particles.push(new particles(Math.random() * canvas_width, Math.random() * canvas_height));
    }
  ...
  function update_particle(cell_data) {
    var pressure_x = (
